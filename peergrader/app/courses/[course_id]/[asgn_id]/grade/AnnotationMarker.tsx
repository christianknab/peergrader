...
const Marker = ({ radius, data, page, selected, index }: { radius: number, data: AnnotationMarkerData, selected: boolean, index:number, page: { width: number, height: number } | undefined }) => {
